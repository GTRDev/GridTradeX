...
contract ModuleKeys {
    ...
    //keccak256("GridTrade");                   // 1.1
    bytes32 internal constant KEY_GRIDTRADE_TOKEN = 0xea7469b14936af748ee93c53b2fe510b9928edbdccac3963321efca7eb1a57a2;
...
contract Module is ModuleKeys {
    ...
    /**
     * @dev Return GridTrade Module address from the Nexus
     * @return Address of the GridTrade Module contract
     */
    function _GridTrade() internal view returns (address) {
        return nexus.getModule(KEY_GRIDTRADE_TOKEN);
    }
 ...
 * @dev    GridTrade is an ERC20 token, with mint privileges governed by mStable
 * governors
 */
contract GridTrade is
    ERC20,
    GovernedMinterRole,
    ERC20Detailed,
    ERC20Burnable
{
    ...
    /**
     * @dev GridTrade simply implements a detailed ERC20 token,
