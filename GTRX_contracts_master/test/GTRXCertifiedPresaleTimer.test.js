...
describe("GTRXCertifiedPresaleTimer", function() {
  ...
  describe("#isStarted", function() {
    it("should be true in the past", async function() {
      ...
      const result = await this.GTRXTimer.isStarted()
      expect(result).to.equal(true)
    })
    it("should be false with default param", async function() {
      await this.GTRXTimer.setStartTime(this.timerParams.startTime, {from: owner})
      const result = await this.GTRXTimer.isStarted()
  ...
  describe("#getEndTime", function() {
    it("should be baseTimer after start time at 0", async function() {
      const result = await this.GTRXTimer.getEndTime("0")
    ...
    it("should be deltaTime * 7 at 799 eth", async function() {
      const actual = await this.GTRXTimer.getEndTime(ether("799"))
    ...
    it("should be deltaTime * 10 at 1301 eth", async function() {
      const actual = await this.GTRXTimer.getEndTime(ether("1301"))
    ...
    it("should be deltaTime * 14 at 5999 eth", async function() {
      const actual = await this.GTRXTimer.getEndTime(ether("5999"))
    ...
    it("should be deltaTime * 18 at 9101 eth", async function() {
      const actual = await this.GTRXTimer.getEndTime(ether("9101"))
    ...
    it("should be deltaTime * 24 at 59999 eth", async function() {
      const actual = await this.GTRXTimer.getEndTime(ether("59999"))
    ...
    it("should be deltaTime * 34 at 599999 eth", async function() {
      const actual = await this.GTRXTimer.getEndTime(ether("599999"))
    ...
    it("should be deltaTime * 44 at 5999999 eth", async function() {
      const actual = await this.GTRXTimer.getEndTime(ether("5999999"))
    ...
    it("should be deltaTime * 44 at 59999999 eth", async function() {
      const actual = await this.GTRXTimer.getEndTime(ether("59999999"))
